<template>
  <!--
Author: Keenthemes
Product Name: CraftProduct Version: 1.1.5
...
-->
  <html lang="en">
    ...
    <head>
      <base href="../" />
      <title>
        Craft | Bootstrap 5 HTML Admin Dashboard Theme by KeenThemes
      </title>
      <meta charset="utf-8" />
      <meta
        name="description"
      ...
      <meta
        property="og:title"
        content="Craft | Bootstrap 5 HTML Admin Dashboard Theme by KeenThemes"
      />
      <meta
        property="og:url"
      ...
      <link
        rel="canonical"
        href="http://preview.keenthemes.comlayouts/extended-aside.html"
      />
    ...
    <body
      id="kt_body"
      class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled aside-fixed aside-extended-enabled aside-secondary-enabled"
    >
      ...
      <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
          ...
          <div
            id="kt_aside"
            class="aside aside-extended ?php Theme::printHtmlClasses('aside', false);?&gt;"
            data-kt-drawer="true"
          ...
          >
            ...
            >
              <!--begin::Brand-->
              <div
                class="aside-logo d-flex flex-column align-items-center flex-column-auto py-5 py-lg-10"
                id="kt_aside_logo"
              >
                <!--begin::Logo-->
                <a href="index.html">
              ...
              >
                <!--begin::Nav scroll-->
                <div
                  class="hover-scroll-y scroll-ms px-2"
                  data-kt-scroll="true"
                ...
                >
                  ...
                  <ul class="nav flex-column" role="tablist">
                    ...
                    <li class="nav-item mb-1" title="Features">
                      <a
                        href="#"
                        class="nav-link w-40px h-40px w-lg-50px h-lg-50px btn btn-icon btn-color-gray-500 btn-active-color-primary btn-active-light active"
                        data-bs-toggle="tab"
                    ...
                    <li class="nav-item mb-1" title="Members">
                      <a
                        href="#"
                        class="nav-link w-40px h-40px w-lg-50px h-lg-50px btn btn-icon btn-color-gray-500 btn-active-color-primary btn-active-light"
                        data-bs-toggle="tab"
              ...
              <!--begin::Footer-->
              <div
                class="aside-footer d-flex flex-column align-items-center flex-column-auto py-4 py-lg-5"
                id="kt_aside_footer"
              >
                <!--begin::Menu-->
                <div class="mb-2">
                  <button
                    type="button"
                    class="btn btn-icon btn-color-gray-500 btn-active-color-primary btn-active-light w-40px h-40px w-lg-50px h-lg-50px"
            ...
            <div class="aside-secondary d-flex flex-row-fluid">
              <!--begin::Workspace-->
              <div
                class="aside-workspace overflow-auto my-5"
                      ...
                      >
                            ...
                            >
                              ...
                              <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                  ...
                                  <a
                                    class="menu-link"
                                    href="pages/user-profile/dashboard.html"
                                  >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            >
                              ...
                              <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                  ...
                                  <a
                                    class="menu-link"
                                    href="account/orders/classic.html"
                                  >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                                ...
                                <div class="menu-item">
                                  ...
                                  <a
                                    class="menu-link"
                                    href="account/orders/details.html"
                                  >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                                ...
                                <div class="menu-item">
                                  ...
                                  <a
                                    class="menu-link"
                                    href="account/orders/sidebar.html"
                                  >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                                ...
                                <div class="menu-item">
                                  ...
                                  <a
                                    class="menu-link"
                                    href="account/orders/tracking.html"
                                  >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                                ...
                                <div class="menu-item">
                                  ...
                                  <a
                                    class="menu-link"
                                    href="account/orders/invoice.html"
                                  >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                                ...
                                <div class="menu-item">
                                  ...
                                  <a
                                    class="menu-link"
                                    href="account/orders/review.html"
                                  >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                        ...
                        >
                          ...
                          <span class="menu-link">
                            <span class="menu-icon">
                              <i
                                class="ki-duotone ki-fingerprint-scanning fs-2"
                              >
                                <span class="path1"></span>
                                <span class="path2"></span>
                                <span class="path3"></span>
                            ...
                            >
                              ...
                              >
                                ...
                                <div class="menu-item">
                                  ...
                                  <a
                                    class="menu-link"
                                    href="authentication/sign-in/password-reset.html"
                                  >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                                ...
                                <div class="menu-item">
                                  ...
                                  <a
                                    class="menu-link"
                                    href="authentication/sign-in/new-password.html"
                                  >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            >
                              ...
                              >
                                ...
                                <div class="menu-item">
                                  ...
                                  <a
                                    class="menu-link"
                                    href="authentication/sign-up/basic.html"
                                  >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                                ...
                                <div class="menu-item">
                                  ...
                                  <a
                                    class="menu-link"
                                    href="authentication/sign-up/multi-steps.html"
                                  >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                                ...
                                <div class="menu-item">
                                  ...
                                  <a
                                    class="menu-link"
                                    href="authentication/sign-up/free-trial.html"
                                  >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                                ...
                                <div class="menu-item">
                                  ...
                                  <a
                                    class="menu-link"
                                    href="authentication/sign-up/coming-soon.html"
                                  >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                        ...
                        >
                          ...
                          <span class="menu-link">
                            <span class="menu-icon">
                              <i class="ki-duotone ki-design fs-2">
                                <span class="path1"></span>
                                <span class="path2"></span>
                              </i>
                            </span>
                          ...
                          <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                ...
                                href="layouts/extended-aside.html"
                              >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Extended Aside</span>
                              </a>
                              <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                class="menu-link"
                                href="layouts/compact-aside.html"
                              >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Compact Aside</span>
                              </a>
                              <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                class="menu-link"
                                href="layouts/minimized-aside.html"
                              >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Minimized Aside</span>
                              </a>
                              <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                class="menu-link"
                                href="layouts/tabbed-content/overview.html"
                              >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Tabbed Content</span>
                              </a>
                              <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
          ...
          >
                      ...
                      >
                        ...
                        <div class="row g-0">
                          ...
                          <div class="col-6">
                            ...
                            >
                              <i
                                class="ki-duotone ki-dollar fs-3x text-primary mb-2"
                              >
                                <span class="path1"></span>
                                <span class="path2"></span>
                                <span class="path3"></span>
                          ...
                          <div class="col-6">
                            ...
                            >
                              <i
                                class="ki-duotone ki-sms fs-3x text-primary mb-2"
                              >
                                <span class="path1"></span>
                                <span class="path2"></span>
                              </i>
                ...
                >
                  ...
                  >
                    ...
                    <ul class="breadcrumb fw-semibold fs-base my-1">
                      ...
                      <li class="breadcrumb-item text-muted">Layouts</li>
                  ...
                  >
                    <a
                      href="#"
                      class="btn bg-body btn-color-gray-700 btn-active-primary me-4"
                      data-bs-toggle="modal"
                            ...
                            <div class="card-body pt-5">
                              ...
                              >
                                ...
                                <div class="d-flex flex-stack flex-wrap">
                                  <span
                                    class="fs-4 text-gray-500 fw-bolder pe-2"
                                    >Announcements</span
                                  >
                                  ...
                                  <div class="carousel-item active">
                                    <div class="carousel-wrapper">
                                      ...
                                      >
                                        <a
                                          href=""
                                          class="fs-2 text-gray-800 text-hover-primary fw-bolder"
                                          >Craft Admin Launch Day</a
                                        >
                                        <p
                                          class="text-gray-600 fs-6 fw-semibold pt-4 mb-0"
                                        >
                                          To start a blog, think of a topic
                                          about and first brainstorm ways to
                                          write details
                                        </p>
                                      </div>
                                      <!--begin::Info-->
                                      <div class="d-flex flex-stack pt-8">
                                        <span
                                          class="badge badge-light-primary fs-7 fw-bolder me-2"
                                          >OCT 05, 10</span
                                        >
                                        <a
                                          href="#"
                      ...
                      <div class="row g-xl-8">
                        ...
                        <div class="col-xl-6">
                          ...
                          <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            >
                              <div
                                class="d-flex flex-stack flex-grow-1 px-9 pt-9 pb-3"
                              >
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px">
                                  <div class="symbol-label">
                                    <i class="ki-duotone ki-gift fs-2x">
                                      <span class="path1"></span>
                                      <span class="path2"></span>
                                      <span class="path3"></span>
                                      <span class="path4"></span>
                          ...
                          <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body pt-5">
                              ...
                              >
                                ...
                                <div class="d-flex flex-stack flex-wrap">
                                  <span
                                    class="text-gray-500 fw-bolder fs-4 pe-2"
                                  ...
                                  <div class="carousel-item active">
                                    <div class="carousel-wrapper">
                                      ...
                                      <div class="d-flex flex-stack pt-7">
                                        <span
                                          class="text-gray-500 fs-6 fw-semibold pe-2"
                        ...
                        <div class="card-body pb-0">
                          ...
                          >
                            ...
                            <div class="pt-12">
                              <!--begin::Title-->
                              <h3
                                class="text-gray-900 text-center fs-1 fw-bolder line-height-lg"
                              >
                              ...
                              <!--begin::Text-->
                              <div
                                class="text-center text-gray-600 fs-5 fw-semibold pt-4 pb-1"
                              >
                            ...
                            <!--begin::Image-->
                            <div
                              class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom card-rounded-bottom max-h-175px min-h-175px"
                              style="
                      ...
                      <div class="card card-xxl-stretch mb-xl-3">
                        ...
                        <div class="card-header border-0 pt-5 pb-3">
                          ...
                          <h3 class="card-title align-items-start flex-column">
                            <span
                              class="card-label fw-bolder text-gray-800 fs-2"
                              >Teams Progress</span
                            >
                            <span class="text-gray-500 fw-semibold mt-2 fs-6"
                              >890,344 Sales</span
                            >
                          </h3>
                          <!--end::Heading-->
                        ...
                        <div class="card-body py-0">
                          ...
                          <div class="table-responsive">
                            ...
                            >
                              <tbody>
                                <tr
                                  class="text-start text-gray-500 fw-bolder fs-7 text-uppercase"
                                >
                                ...
                                <tr>
                                  ...
                                  <td class="p-0">
                                    <div class="d-flex align-items-center">
                                      ...
                                      <div class="ps-3">
                                        ...
                                        >
                                        <span
                                          class="text-gray-500 fw-semibold d-block"
                                  ...
                                  <td>
                                    <span
                                      class="text-gray-800 fw-bolder fs-5 d-block"
                                      >Intertico</span
                                    >
                                  ...
                                  <td>
                                    ...
                                    >
                                      <span
                                        class="text-gray-500 me-2 fw-bolder mb-2"
                                        >65%</span
                                      >
                                      <div
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="d-flex flex-column w-100 me-2">
                                      ...
                                      >
                                      <div
                                        class="progress bg-light-primary w-100 h-5px"
                                      >
                                        <div
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="d-flex flex-column w-100 me-2">
                                      ...
                                      >
                                      <div
                                        class="progress bg-light-success w-100 h-5px"
                                      >
                                        <div
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="d-flex flex-column w-100 me-2">
                                      ...
                                      >
                                      <div
                                        class="progress bg-light-info w-100 h-5px"
                                      >
                                        <div
                    ...
                    <div class="col-xxl-4">
                      ...
                      <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-header border-0 py-5">
                          <h3 class="card-title align-items-start flex-column">
                            <span
                              class="card-label fw-bolder text-gray-900 fs-2"
                              >Achievements</span
                            >
                            <span class="text-gray-500 mt-2 fw-semibold fs-6"
                              >100k+ sales templates sales</span
                            >
                          </h3>
                          <div class="card-toolbar">
                            <!--begin::Menu-->
                            ...
                            >
                              <i
                                class="ki-duotone ki-category fs-2 text-primary"
                              >
                                <span class="path1"></span>
                                <span class="path2"></span>
                                <span class="path3"></span>
                            ...
                            <div class="d-flex flex-stack mb-6">
                              ...
                              <div class="d-flex align-items-center me-2">
                                ...
                                <div class="symbol symbol-45px me-5">
                                  <span class="symbol-label bg-light-success">
                                    <i
                                      class="ki-duotone ki-/compass fs-2 text-success"
                                    ></i>
                                  </span>
                                </div>
                                <!--end::Symbol-->
                                ...
                                <div>
                                  ...
                                  >
                                  <div
                                    class="fs-7 text-gray-500 fw-semibold mt-1"
                                  >
                                    12 Hours, 4 Commits
                                  </div>
                                </div>
                              ...
                              <a href="#" class="btn btn-icon btn-light btn-sm">
                                <i
                                  class="ki-duotone ki-arrow-right fs-4 text-gray-500"
                                >
                                  <span class="path1"></span>
                                  <span class="path2"></span>
                                </i>
                            ...
                            <div class="d-flex flex-stack mb-6">
                              ...
                              <div class="d-flex align-items-center me-2">
                                ...
                                <div class="symbol symbol-45px me-5">
                                  <span class="symbol-label bg-light-danger">
                                    <i
                                      class="ki-duotone ki-element-11 fs-2 text-danger"
                                    >
                                      <span class="path1"></span>
                                      <span class="path2"></span>
                                      <span class="path3"></span>
                            ...
                            <div class="d-flex flex-stack mb-">
                              ...
                              <div class="d-flex align-items-center me-2">
                                ...
                                <div class="symbol symbol-45px me-5">
                                  <span class="symbol-label bg-light-info">
                                    <i
                                      class="ki-duotone ki-abstract-18 fs-2 text-info"
                                    >
                                      <span class="path1"></span>
                                      <span class="path2"></span>
                                    </i>
                  ...
                  <div class="row g-5 g-xl-8">
                    ...
                    <div class="col-xl-4">
                      ...
                      <div class="card card-xl-stretch mb-xl-8">
                        ...
                        >
                          <h3 class="card-title align-items-start flex-column">
                            <span class="fw-bolder text-gray-900 fs-2"
                              >My Competitors</span
                            >
                            <span class="text-gray-500 mt-2 fw-semibold fs-6"
                        ...
                        <div class="card-body pt-5">
                          ...
                          <div class="d-flex mb-6">
                            <!--begin::Symbol-->
                            <div
                              class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4"
                            >
                              <img
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                <span
                                  class="text-gray-500 fw-semibold fs-7 my-1"
                                  >Study highway types</span
                                >
                              ...
                              <div class="text-end py-lg-0 py-2">
                                ...
                                >
                                <span
                                  class="text-gray-500 fs-7 fw-semibold d-block"
                                  >Sales</span
                                >
                              </div>
                              <!--end::Info-->
                      ...
                      <div class="card card-xl-stretch mb-xl-8">
                                ...
                                <div class="mb-10">
                                  ...
                                  <div>
                                    <select
                                      ...
                                      data-dropdown-parent="#kt_menu_66289cc641880"
                        ...
                        <div class="card-body pt-5">
                          ...
                          <div class="d-flex flex-stack mb-7">
                            ...
                            <a
                              href="pages/user-profile/overview.html"
                              class="btn btn-light btn-color-muted fw-bolder btn-sm px-5"
                              >Details</a
                            >
                            <!--end::Details-->
                          </div>
                            ...
                            <div class="d-flex flex-stack pb-10">
                              ...
                              <div class="d-flex">
                                ...
                                <div class="symbol symbol-35px me-5 mt-2">
                                  <span class="symbol-label">
                                    <i
                                      class="ki-duotone ki-abstract-26 fs-2 text-gray-600"
                                    >
                                      <span class="path1"></span>
                                      <span class="path2"></span>
                                    </i>
                                ...
                                <div class="pe-3">
                                  <a
                                    href="#"
                                    class="fs-5 text-gray-800 text-hover-primary fw-bolder"
                                    >Developer Library Added</a
                                  >
                                  <div class="text-gray-500 fw-semibold mt-1">
                                    New
                                    <a href="#" class="link-primary p-1"
                                      >Author Account</a
                                    >with Affiliate
                                  </div>
                                </div>
                              ...
                              <!--end::Section-->
                              <!--begin::Label-->
                              <span class="fw-bolder fs-7 text-gray-500"
                                >2HR</span
                              >
                              <!--end::Label-->
                            </div>
                            ...
                            <div class="d-flex flex-stack pb-10">
                              ...
                              <div class="d-flex">
                                ...
                                <div class="symbol symbol-35px me-5 mt-2">
                                  <span class="symbol-label">
                                    <i
                                      class="ki-duotone ki-credit-cart fs-2 text-gray-600"
                                    >
                                      <span class="path1"></span>
                                      <span class="path2"></span>
                                    </i>
                                ...
                                <div class="pe-3">
                                  <a
                                    href="#"
                                    class="fs-5 text-gray-800 text-hover-primary fw-bolder"
                                    >Payments Methods Added</a
                                  >
                                  <div class="text-gray-500 fw-semibold mt-1">
                                    Added
                                    <span class="text-gray-700 pe-1"
                                      >Payoneer</span
                                    >&
                            ...
                            <div class="d-flex flex-stack pb-10">
                              ...
                              <div class="d-flex">
                                ...
                                <div class="symbol symbol-35px me-5 mt-2">
                                  <span class="symbol-label">
                                    <i
                                      class="ki-duotone ki-basket fs-2 text-gray-600"
                                    >
                                      <span class="path1"></span>
                                      <span class="path2"></span>
                                      <span class="path3"></span>
                                ...
                                <div class="pe-3">
                                  ...
                                  >
                                  <div class="text-gray-500 fw-semibold mt-1">
                                    <a href="#" class="link-primary pe-1"
                                      >#XDT-034</a
                                    >order received
                                  </div>
                                </div>
                            ...
                            <div class="d-flex flex-stack pb-10">
                              ...
                              <div class="d-flex">
                                ...
                                <div class="symbol symbol-35px me-5 mt-2">
                                  <span class="symbol-label">
                                    <i
                                      class="ki-duotone ki-address-book fs-2 text-gray-600"
                                    >
                                      <span class="path1"></span>
                                      <span class="path2"></span>
                                      <span class="path3"></span>
                                ...
                                <div class="pr-3">
                                  <a
                                    href="#"
                                    class="fs-5 text-gray-800 text-hover-primary fw-bolder"
                                    >New User Library Added</a
                                  >
                                  <div
                                    class="fs-7 text-gray-500 fw-semibold mt-2"
                                  >
                                    New
                                    <a href="#" class="link-primary pe-1"
                                      >Author Account</a
                            ...
                            <div class="d-flex flex-stack">
                              ...
                              <div class="d-flex">
                                ...
                                <div class="symbol symbol-35px me-5 mt-2">
                                  <span class="symbol-label">
                                    <i
                                      class="ki-duotone ki-document fs-2 text-gray-600"
                                    >
                                      <span class="path1"></span>
                                      <span class="path2"></span>
                                    </i>
            ...
            <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
              <!--begin::Container-->
              <div
                class="container-fluid d-flex flex-column flex-md-row flex-stack"
              >
                <!--begin::Copyright-->
                        ...
                        <div class="fv-row mb-8">
                          ...
                          >
                            ...
                            <div class="dz-message needsclick">
                              <!--begin::Icon-->
                              <i
                                class="ki-duotone ki-file-up fs-3hx text-primary"
                              >
                                <span class="path1"></span>
                                <span class="path2"></span>
                              </i>
                              ...
                              <div class="d-flex align-items-center">
                                ...
                                <div class="ms-6">
                                  <a
                                    href="#"
                                    class="fs-5 fw-bold text-gray-900 text-hover-primary mb-2"
                                    >Avionica Technical Requirements</a
                                  >
                                  <div class="fw-semibold text-muted">
                                    230kb
                                  </div>
...
export default {
  name: 'YourComponent',
  mounted() {
    // Load external scripts when the component is mounted
    this.loadScript('../../assets/plugins/custom/leaflet/leaflet.bundle.js')
      .then(() =>
        this.loadScript(
          '../../assets/plugins/custom/datatables/datatables.bundle.js'
        )
      )
      .then(() => this.loadScript('../../assets/js/widgets.bundle.js'))
      .then(() => this.loadScript('../../assets/js/custom/widgets.js'))
      .then(() => this.loadScript('../../assets/js/custom/apps/chat/chat.js'))
      .then(() =>
        this.loadScript(
      ...
      .then(() =>
        this.loadScript('../../assets/js/custom/utilities/modals/create-app.js')
      )
      .then(() =>
        this.loadScript(
